...
@test "the correct versions of tools are installed with a complex configuration file (0.15.0)" {
  asdf_current="$(cat <<EOF
...
@test "the correct updates of tools are made with a complex configuration file" {
  asdf_current="$(cat <<EOF
Name     Version                 Source                         Installed
elixir   1.12.0-rc.0             /home/example/.tool-versions   true
erlang   24.0.3                  /home/example/.tool-versions   true
java     adoptopenjdk-16.0.1+9   /home/example/.tool-versions   true
nodejs   13.14.0                 /home/example/.tool-versions   true
python   3.9-dev                 /home/example/.tool-versions   true
ruby     2.7.0                   /home/example/.tool-versions   true
EOF
)"
...
@test "the correct updates of tools are made with a complex configuration file (0.15.0)" {
  asdf_current="$(cat <<EOF
...
@test "no updates with a complex configuration file" {
  asdf_current="$(cat <<EOF
Name            Version          Source                         Installed
elixir          1.12.2-otp-24    /home/example/.tool-versions   true
erlang          24.0.5           /home/example/.tool-versions   true
java            openjdk-16.0.2   /home/example/.tool-versions   true
nodejs          16.7.0           /home/example/.tool-versions   true
python          3.9.6            /home/example/.tool-versions   true
ruby            2.7.2            /home/example/.tool-versions   true
EOF
)"
...
@test "no updates with a complex configuration file (0.15.0)" {
  asdf_current="$(cat <<EOF
